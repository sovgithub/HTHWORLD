...
- `yarn build` to compile the source code to plain javascript
- `yarn build --watch` if you will be doing active development, to compile on a file save. Since we're using typescript, you also need to run `yarn postbuild` to update the compiled assets.
